...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Ноя 01 2020 г., 16:49
...
('student', '32', 1603890709),
('student', '33', 1603890715),
('student', '34', 1603890775),
('student', '37', 1603977798),
('student', '38', 1603977878),
('student', '39', 1603977883);
...
(3, 'П-17-42Б', 5, '2017-09-01', '2021-09-01'),
(6, 'П-17-42Б', 5, '2017-09-01', '2021-09-01'),
(7, 'П-17-42Б', 5, '2017-09-01', '2021-09-01');
...
(3, 'Информационные системы', 2, 214, 1),
(4, 'Информационные системы', 2, 214, 1),
(5, 'Информационные системы', 2, 214, 1),
(6, 'Информационные системы', 2, 214, 1),
(7, 'Информационные системы', 2, 214, 1),
(8, 'Информационные системы', 2, 214, 1),
(9, 'Информационные системы', 2, 214, 1),
(10, 'Информационные системы', 2, 214, 1);
...
(1, 'Смит', 'Джон', 'Тимофеевич', 'admin', '$2y$13$u9hGuhVBf9yCSNeLI4gW8OB8FkdDY7Qc28oiuBEeYsmmJNeTs55ca', 'TCezsXi2gyh8k1LVYA_KbuO_efGhOejQ', 1604323595, 1, '2001-03-15', 1, 1),
...
(35, '1', '2', '3', '12345', '$2y$13$u9hGuhVBf9yCSNeLI4gW8OB8FkdDY7Qc28oiuBEeYsmmJNeTs55ca', 'bG-WOKw5gAMyg_XdJs_zF2Z0JNUxfmQv', 1604063873, 1, '2020-09-20', 4, 1),
(36, '1', '2', '3', '123456', '$2y$13$u9hGuhVBf9yCSNeLI4gW8OB8FkdDY7Qc28oiuBEeYsmmJNeTs55ca', 'BFBu3hRJwYHYm3pEOQUGpJTeupwg3e-b', 1604117950, 1, '2020-09-20', 4, 1),
(37, '1', '2', '3', '12345678', '$2y$13$Lg6B3TG3Uo3ZrTo1L.Aam.bTTcccAMubx54YsvR1BXBeUNytERTKS', 'SJfJgq6BjYik_WN_AmYgrmWC1plWgmrS', 1604227991, 2, '2020-10-01', 3, 1),
(40, 'Громов', 'Антон', 'Анатольевич', 'qmarvolo', '$2y$13$u9hGuhVBf9yCSNeLI4gW8OB8FkdDY7Qc28oiuBEeYsmmJNeTs55ca', 'TjsfFtUTCFOakdFU6VV2V19n8b_IG9Zg', 1604316542, 1, '2002-04-05', 1, 1);
...
--
ALTER TABLE `lesson_num`
  MODIFY `lesson_num_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `user`
  MODIFY `user_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
